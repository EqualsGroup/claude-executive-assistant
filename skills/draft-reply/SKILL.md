...
- **Source:** Email, Slack, Notion comment, or ad-hoc
...
2. Match the channel — Slack is casual, email slightly longer, Notion is structured
...
- Send via the appropriate tool (Slack, email, Notion comment)
